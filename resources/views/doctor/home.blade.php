...
<body>
    ...
    <main class="main-content">
        <div class="dashboard-header">
            <h2 class="dashboard-title">Doctor/Surgeon Dashboard</h2>
 ...
 <div class="content-wrapper">
    ...
    <tr>
        ...
        <td>{{ $book->Status }}</td>
            ...
            <div class="card-body">
                <h4 class="card-title">Refer Booking To A Physiotherapist</h4>
                <form id="bookingForm" action="{{ url('/refer-doctor') }}" method="POST">
@csrf
                    ...
                    <div class="form-group">
                        <label for="referral_doctor_id">Referral Doctor ID</label>
                        <select class="form-control" id="referral_doctor_id" name="referral_doctor_id" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="details1" name="details1" rows="4" required></textarea>
                    </div>

                    <div class="submit-button">
                        <button type="submit" class="submit-btn">Submit to Refer</button>
                    </div>
                </form>
            </div>
